...
## Quick Start
1. **Download the Data Pack**: [Download babel_v2.3.zip](https://github.com/JiFish/babel/releases/download/v2.3/babel_v2.3.zip).
...
- **[babel-bookish-zombies_v2.3.zip](https://github.com/JiFish/babel/releases/download/v2.3/babel-bookish-zombies_v2.3.zip)**: Zombies can drop books when killed by a player.
- **[babel-only-chests_v2.3.zip](https://github.com/JiFish/babel/releases/download/v2.3/babel-only-chests_v2.3.zip)**: Books are chest-exclusive (no fishing or raid reward).
- **[babel-no-libraries_2.3.zip](https://github.com/JiFish/babel/releases/download/v2.3/babel-no-libraries_v2.3.zip)**: Removes Lost Libraries.
- **[babel-fairytales_2.3.zip](https://github.com/JiFish/babel/releases/download/v2.3/babel-fairytales_v2.3.zip)**: Replaces lore books with public domain fairy tales.
- **[babel-recipe_v2.3.zip](https://github.com/JiFish/babel/releases/download/v2.3/babel-recipe_v2.3.zip)**: Adds the below crafting recipe for random books.
- **[babel-more-drops_v2.3.zip](https://github.com/JiFish/babel/releases/download/v2.3/babel-more-drops_v2.3.zip)**: Increases book weight in loot tables significantly. Also includes zombie book drops.
...
1. **Download the Tool**:
   - [babel-builder-windows_v2.3.zip](https://github.com/JiFish/babel/releases) (Windows)
   - [babel-builder-python_v2.3.zip](https://github.com/JiFish/babel/releases) (Python)
2. **Run the Tool**:
   - Windows: `babel.exe`
