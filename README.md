...
- **[babel-more-drops_v2.2.2.zip](https://github.com/JiFish/babel/releases/download/v2.2.2/babel-recipe_v2.2.2.zip)**: Increases book weight in loot tables significantly. Also includes zombie book drops.
